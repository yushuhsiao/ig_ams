...
namespace InnateGlory
{
    ...
    public class SqlAppSettingsConfigurationProvider : AppSettingBinder.Provider
    {
        ...
        public override void OnInit(IServiceProvider service)
        {
            ...
            if (obj != null) return;
            Interlocked.Exchange(ref _dataService, _service.GetService<DataService>());
        ...
        public override bool OnGetValue(string section, string key, out string value, params object[] index)
        {
