    ...
    partial class Extension
    {
        ...
        internal static PropertyInfo ToProperty(this MemberInfo m, ref PropertyInfo cache)
        {
            ...
            if (p == null)
            {
                if (m != null)
                {
                    foreach (PropertyInfo pp in m.DeclaringType.GetProperties(_TypeExtensions.BindingFlags0))
                    {
        ...
        internal static PropertyInfo ToProperty(this MemberInfo m)
        {
            ...
            lock (cache_ToProperty)
            {
                ...
                else
                {
                    ...
                    foreach (PropertyInfo p in t.GetProperties(_TypeExtensions.BindingFlags0))
                    {
        ...
        internal static EventInfo ToEvent(this MemberInfo m)
        {
            ...
            lock (cache_ToEvent)
            {
                ...
                else
                {
                    ...
                    foreach (EventInfo e in t.GetEvents(_TypeExtensions.BindingFlags0))
                    {
		...
		[DebuggerStepThrough]
        public static object Invoke2(this MethodBase m, object obj, params object[] parameters)
        {
...
namespace System
{
    ...
    //{
    //    [DebuggerStepThrough]
    //    public static T GetCustomAttribute<T>(this System.Reflection.ICustomAttributeProvider obj, bool inherit = false) where T : Attribute
    //    {
    //        return System.Reflection.Extension.GetCustomAttribute<T>(obj, inherit);
    //    }
    //}
}