...
namespace System.Configuration
{
    partial class app
    {
        partial class config
        {
            ...
            public static void init(WebHostBuilderContext host)
            {
                lock (_sync) _Configuration = host.Configuration;
            }
            public static void init(IConfiguration config)
            {
                lock (_sync) _Configuration = config;
            }
