...
namespace System.Data
{
    ...
    public static class DbImport
    {
        ...
        [_DebuggerStepThrough]
        public static T ToObject<T>(this DbDataReader r, Func<T> create)
        {
            T obj = create();
            FillObject(r, obj);
            return obj;
        ...
        [_DebuggerStepThrough]
        public static object ToObject(this DbDataReader r, Type objectType)
        {
        ...
        [_DebuggerStepThrough]
        public static int FillObject(this DbDataReader r, object obj)
        {
            return DbImport.Contract.GetContract(obj).FillObject(r, obj);
        }
        ...
        class Contract : Dictionary<string, List<DbImportAttribute>>, IDbImport
        {
            ...
            Contract(Type type)
            {
                foreach (MemberInfo m in type.GetMembers(_TypeExtensions.BindingFlags1))
                {
            ...
            void IDbImport.Import(DbDataReader reader, int fieldIndex, string fieldName, object value) { }
            void IDbImport.Missing(DbDataReader reader, int fieldIndex, string fieldName, object value) { }
        }
    ...
    {
        void Import(DbDataReader reader, int fieldIndex, string fieldName, object value);
        void Missing(DbDataReader reader, int fieldIndex, string fieldName, object value);
    }
}