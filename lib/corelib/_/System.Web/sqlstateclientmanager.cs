...
namespace System.Web.SessionState {
    ...
    internal class SqlSessionStateStore : SessionStateStoreProviderBase {
        ...
        void OneTimeInit() {
			SessionStateSection config = null;// RuntimeConfig.GetAppConfig().SessionState;
        ...
        SessionStateStoreData DoGet(HttpContext context, String id, bool getExclusive,
            ...
            try {
                ...
                using(stream = new MemoryStream(buf)) {
					item = null; //SessionStateUtility.DeserializeStoreData(context, stream, s_configCompressionEnabled);
