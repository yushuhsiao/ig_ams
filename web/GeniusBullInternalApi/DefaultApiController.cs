...
namespace ApiServer
{
    public class DefaultApiController : ApiController
    {
        ...
        /// </param>
        /// <returns></returns>
        [HttpGet, Route("~/AuthorizeToken/{accessToken}/{gameId}/{tableId}/{tableToken}")]
        public IHttpActionResult AuthorizeToken(string accessToken, int gameId, int tableId, string tableToken)
        {
            return Ok();
        }
