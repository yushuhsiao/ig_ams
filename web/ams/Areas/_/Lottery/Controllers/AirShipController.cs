...
using PKTen.Models;
namespace ams.Areas.AirShip.Controllers
{
    [RouteArea(_url.areas.Lottery)]
    [Route("~/lottery/{action}")]
    public class AirShipController : _Controller
    {
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["GameDB"].ToString());

        public ActionResult AirShipPcIndex()
        {
            string sql = "Select SID, Dish, UpdateTime, UpdateUser From Pc_AirShip_Sample";
        ...
        public ActionResult AirShipPcWaterEdit(int SID)
        {
            string sqlWater = "select SID, Dish, Sum3, Sum4, Sum5, Sum6, Sum7, Sum8, Sum9, Sum10, Sum11, Sum12, Sum13, Sum14, Sum15, "
                 ...
                 + " from Pc_AirShip_Sample where SID = " + SID;
        ...
        [HttpPost]
        public ActionResult AirShipPcWaterEdit(PK10_PC postback)
        {
            string SqlEdit = "update Pc_AirShip_Sample SET Dish = @Dish,"
            ...
            if (this.ModelState.IsValid)
            {
                ...
                + " Sum16, Sum17, Sum18, Sum19, SumSmall, SumBig, SumOdd, SumEven, ChampionBuild, Car1, Car2, Car3, Car4,"
                + " Car5, Car6, Car7, Car8, Car9, Car10, CarSmall, CarBig, CarOdd, CarEven, CarDra, CarTig, BallMaxMoney "
                + " from Pc_AirShip_Sample where SID =" + postback.SID;
                //conn.Open();
                ...
                return RedirectToAction("AirShipPcIndex");
            }
            else
            {
        ...
        public ActionResult AirShipPCDetailEdit(int SID)
        {
            string sqlWater = "select SID, Dish, Sum3, Sum4, Sum5, Sum6, Sum7, Sum8, Sum9, Sum10, Sum11, Sum12, Sum13, Sum14, Sum15, "
                 + " Sum16, Sum17, Sum18, Sum19, SumSmall, SumBig, SumOdd, SumEven, ChampionBuild, Car1, Car2, Car3, Car4, "
                 + " Car5, Car6, Car7, Car8, Car9, Car10, CarSmall, CarBig, CarOdd, CarEven, CarDra, CarTig, BallMaxMoney "
        ...
        [HttpPost]
        public ActionResult AirShipPCDetailEdit(PK10_PC postback)
        {
            string SqlEdit = "update Pc_AirShip_Sample SET Dish = @Dish,"
                        + " Sum3 = @Sum3, Sum4 = @Sum4, Sum5 = @Sum5, Sum6 = @Sum6, Sum7 = @Sum7, "
                        + " Sum8 = @Sum8, Sum9 = @Sum9, Sum10= @Sum10, Sum11 = @Sum11, Sum12 = @Sum12, "
            ...
            if (this.ModelState.IsValid)
            {
                ...
                //conn.Close();
                return RedirectToAction("AirShipPCIdex");
            }
            else
            {
                return View(postback);
        ...
        public ActionResult AirShipPCEnableEdit(int SID)
        {
            string sqlWater = "select SID, Dish, Sum3, Sum4, Sum5, Sum6, Sum7, Sum8, Sum9, Sum10, Sum11, Sum12, Sum13, Sum14, Sum15, "
                 + " Sum16, Sum17, Sum18, Sum19, SumSmall, SumBig, SumOdd, SumEven, ChampionBuild, Car1, Car2, Car3, Car4, "
                 + " Car5, Car6, Car7, Car8, Car9, Car10, CarSmall, CarBig, CarOdd, CarEven, CarDra, CarTig, BallMaxMoney "
        ...
        [HttpPost]
        public ActionResult AirShipPCEnableEdit(PK10_PC postback)
        {
            string SqlEdit = " update Pc_AirShip_Sample SET Dish=@Dish,"
                        + " Sum3 = @Sum3, Sum4 = @Sum4, Sum5 = @Sum5, Sum6 = @Sum6, Sum7 = @Sum7, "
                        + " Sum8 = @Sum8, Sum9 = @Sum9, Sum10= @Sum10, Sum11 = @Sum11, Sum12 = @Sum12, "
        ...
        [HttpPost]
        public ActionResult AirShipPCNameEdit(PK10_PC postback)
        {
            string SqlEdit = "update Pc_AirShip_Sample SET Dish = @Dish, "
                        + " Sum3 = @Sum3, Sum4 = @Sum4, Sum5 = @Sum5, Sum6 = @Sum6, Sum7 = @Sum7, "
                        + " Sum8 = @Sum8, Sum9 = @Sum9, Sum10= @Sum10, Sum11 = @Sum11, Sum12 = @Sum12, "
