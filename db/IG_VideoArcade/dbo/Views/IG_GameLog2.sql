...
FROM              (SELECT          Id, SerialNumber, PlayerId, GameId, ActionType, Bets, Odds, Symbols, GameType, Param_1, Param_2, 
                            ...
                            FROM               dbo.GameSpin
                            UNION
                            SELECT          Id, SerialNumber, PlayerId, GameId, ActionType, NULL AS Bets, NULL AS Odds, NULL AS Symbols, 
                                                        GameType, NULL AS Param_1, NULL AS Param_2, NULL AS Param_3, NULL AS Param_4, NULL 
                                                        AS Param_5, NULL AS Pays, NULL AS WinSpots, GameFinished, Deal_1, Deal_2, BackupCards, 
                                                        WinType, JPType, BetAmount, WinAmount, Balance, InsertDate
