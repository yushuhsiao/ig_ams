CREATE VIEW dbo.PicturesX
AS
SELECT          a.ID, a.CorpID, a.MemberID, a.ImageType, a.TakePictureKey, a.Success, a.CreateTime, b.datalen AS ImageSize, 
                            c.datalen AS TemplateSize
