...
CREATE PROCEDURE dbo.sp_WriteGameLog
    ...
    @PullAmount     decimal(18, 6) = null,  -- JackpotLog.WinAmount
    @PullJPType     varchar(20) = null      -- JackpotLog.JackpotType
AS
BEGIN
    if @PullAmount is null
        ...
        insert into IG_GameLog( SerialNumber, PlayerId, GameId, ActionType, Bets, Odds, Symbols, GameType, Param_1, Param_2, Param_3, Param_4, Param_5, Pays, WinSpots, Deal_1, Deal_2, BackupCards, WinType, JPType    , BetAmount, WinAmount, Balance, Amount    , JP_Balance, JP_Base, JP_Ratio, JP_BaseAmount, JP_FillAmount, JP_GRAND, JP_MAJOR, JP_MINOR, JP_MINI, InsertDate)
        values                (@SerialNumber,@PlayerId,@GameId,@ActionType,@Bets,@Odds,@Symbols,@GameType,@Param_1,@Param_2,@Param_3,@Param_4,@Param_5,@Pays,@WinSpots,@Deal_1,@Deal_2,@BackupCards,@WinType,@JPType    ,@BetAmount,@WinAmount,@Balance,@Amount    ,null       ,null     ,null     ,null          ,null         ,@JP_GRAND,@JP_MAJOR,@JP_MINOR,@JP_MINI, getdate())
                             ,(@SerialNumber,@PlayerId,@GameId,null       ,null ,null ,null    ,null     ,null    ,null    ,null    ,null    ,null    ,null ,null     ,null   ,null   ,null        ,null    ,@PullJPType,@BetAmount,@WinAmount,@Balance,@PullAmount,@JP_Balance,@JP_Base,@JP_Ratio,@JP_BaseAmount,@JP_FillAmount,null     ,null     ,null     ,null    , getdate())
END