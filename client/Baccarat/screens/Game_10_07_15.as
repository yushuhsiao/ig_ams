...
private function textEffect(e:Event,i:Number,b:Number):void{
	
	if (i != b){
         //  bet_text[i].text += 1.toString();
          // counter++;
   }
   else{
      removeEventListener(Event.ENTER_FRAME,textEffect);
   }
